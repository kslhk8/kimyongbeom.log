...
export function useMDXComponents(
  ...
  return {
    ...
    p: ({ className, ...props }: ComponentPropsWithoutRef<"p">) => (
      <p
        className={cn("my-4.5 text-[1rem] leading-[1.7] text-primary", className)}
        {...props}
      />
    ),
    ul: ({ className, ...props }: ComponentPropsWithoutRef<"ul">) => (
      <ul
        className={cn(
          "my-4.5 list-['■'] space-y-2 pl-6 text-[1rem] leading-[1.7] text-primary marker:text-[1em] marker:text-primary [&_ul]:list-['-']",
          className
        )}
        {...props}
      />
    ...
    ol: ({ className, ...props }: ComponentPropsWithoutRef<"ol">) => (
      <ol
        className={cn(
          "my-4.5 list-decimal space-y-2 pl-6 text-[1rem] leading-[1.7] text-primary marker:text-[#b38b2d]",
          className
        )}
        {...props}
      />
    ...
    blockquote: ({ className, ...props }: ComponentPropsWithoutRef<"blockquote">) => (
      <blockquote
        className={cn(
          "my-8 rounded-r-2xl border-l-4 border-[#e7d7aa] bg-[#fff8e7] px-5 py-4 text-[1.02rem] leading-[1.7] text-[#57534e]",
          className
        )}
        {...props}
      />
    ...
    pre: ({ className, ...props }: ComponentPropsWithoutRef<"pre">) => (
      <pre
        className={cn(
          "my-8 overflow-x-auto rounded-2xl border border-[#FBEECC] bg-white px-5 py-4 [&_*]:!border-0 [&_*]:!bg-transparent",
          className
        )}
        {...props}
      />
