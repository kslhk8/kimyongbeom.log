export const metadata = {
  title: "Context, Portal, Render Props, PropTypes, Reconciliation, Virtual DOM, React Dev Tools",
  description: "",
  date: "2022-04-05",
  category: "React",
  tags: ["Context", "Portal", "Render Props", "PropTypes", "Reconciliation", "Virtual DOM"],
  published: true,
};
