...
export default function Home() {
  ...
  return (
    <section className="space-y-8">
      <div className="overflow-hidden rounded-2xl border border-zinc-200/80 bg-[#FFFBF0] shadow-[0_1px_2px_rgba(15,23,42,0.03)]">
      ...
      <div className="flex items-center justify-center gap-2">
        <button
          ...
          className="flex h-9 w-9 items-center justify-center rounded-full border border-zinc-200 bg-[#FFFBF0] text-zinc-600 transition hover:border-zinc-300 hover:text-zinc-950 disabled:cursor-not-allowed disabled:opacity-40"
            ...
            <button
              ...
              className={`flex h-9 min-w-9 items-center justify-center rounded-full px-3 text-sm transition ${
                currentPage === pageNumber
                  ? "bg-[#FBEECC] text-zinc-950 font-bold"
                  : "text-zinc-600 hover:bg-[#FFF3D6]/60 hover:text-zinc-950"
              }`}
            >
              {pageNumber}
            </button>
